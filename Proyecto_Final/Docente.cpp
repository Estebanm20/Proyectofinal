...
Docente::Docente(string nombre, string DNI, string correo, string direccion, string telefono, string _contrasenia, string _ID, string _Curso):Persona(nombre,DNI,correo,direccion,telefono){
