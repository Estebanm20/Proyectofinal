...
Estudiante::Estudiante(string nombre, string DNI, string correo, string direccion, string telefono, string _contrasenia, string _ID, int _Creditos,float _Promedio, int _Cursos):Persona(nombre,DNI,correo,direccion,telefono){
