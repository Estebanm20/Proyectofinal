...
int main(){
    ...
    Docente SamuelDocente = Docente("Klins","74160154","klins@ucsp.edu.pe","Invasión 5 calamina 8","923121311", "29", "Samuel","Matematica");
    SamuelDocente.imprime();

    Estudiante SamuelEstudiante = Estudiante("Samuel","92322","samuel@ucsp.edu.pe","Invasión 5 calamina 8","923123131","29","Samuel",22,15.5,6);
        ...
        switch(r){
            ...
            case 2:
                ...
                for(int i = 0; i < VecDocentes.size(); i++){
                    if(a == VecDocentes.at(i).getID() && b == VecDocentes.at(i).getcontrasenia()){
                        Adm = 1;
            ...
            case 1:
                ...
                for(int i = 0; i < VecEstudiantes.size(); i++){
                    if(a == VecEstudiantes.at(i).getID() && b == VecEstudiantes.at(i).getcontrasenia()){
                        Clt = 1;
                        ...
                        cout << "ID o contrasenia incorrectos" << endl;
                    }
                }
        }
        if (r != 1 || r != 2 || r == 3){
